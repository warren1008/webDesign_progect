...
<div class="container">
    ...
    <section class="feature-card-grid promotion-grid">
        <?php foreach ($promotions as $index => $promotion): ?>
            ...
            ?>
            <article class="innovation-card promotion-card flip-card" data-promotion-card data-flip-card tabindex="0">
                <div class="flip-card-inner">
                    <div class="flip-card-face flip-card-front">
                        <span class="card-index">0<?php echo $index + 1; ?></span>
                        <span class="status-pill is-live">活動中</span>
                        <span class="flip-card-icon" aria-hidden="true">SALE</span>
                    ...
                    <div class="flip-card-face flip-card-back">
                        <strong>優惠會自動判斷，不用另外輸入折扣碼。</strong>
