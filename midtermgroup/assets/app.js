...
document.addEventListener('DOMContentLoaded', () => {
    ...
    Object.assign(zhTranslations, {
        ...
        'Complete a few demo orders to activate sales and inventory insights.': '完成幾筆示範訂單後，即可啟用銷售與庫存分析。',
        ...
        'Local demo link': '本機展示連結',
        'Email delivery is replaced by this visible link on localhost.': '在 localhost 測試時，以畫面連結取代寄送電子郵件。',
        ...
        'Invalid demo card details. Visa starts with 4, Mastercard starts with 5, Amex starts with 3.': '示範卡片資料無效：Visa 以 4 開頭、Mastercard 以 5 開頭、Amex 以 3 開頭。',
    ...
    Object.assign(zhTranslations, {
        ...
        'Order complete': '訂單完成',
        'QR code simulator': 'QR Code 掃描模擬器',
    ...
    const enTitleTranslations = {
        ...
        '活動與會員管理－管理後台': 'Campaign Management - Admin'
    };
    ...
    const enTranslations = {
        ...
        '期末展示限定收藏碗，限量 12 份': 'A presentation-exclusive collectible bowl, limited to 12.',
        '立即兌換': 'Redeem Now',
        '點數不足': 'Not Enough Points',
        '模擬合作店家': 'Partner Store Simulation',
        '取餐碼也是合作優惠通行證': 'Your pickup code unlocks partner offers',
        '完成拉麵訂單後，可在合作品牌出示取餐碼享用跨店優惠。此區為期末展示用模擬商圈。': 'Show your pickup code at partner brands after ordering to unlock cross-store offers.',
        '營業中': 'OPEN',
        '即將打烊': 'CLOSING SOON',
        '休息中': 'CLOSED',
        ...
        '主打無糖冷泡茶與氣泡飲的模擬合作品牌': 'A simulated partner specializing in cold-brew tea and sparkling drinks.',
...
(() => {
    ...
    i18n.src = new URL('i18n.js?v=20260616j', base).href;
    i18n.onload = () => {
        const innovations = document.createElement('script');
        innovations.src = new URL('innovations.js?v=20260616j', base).href;
