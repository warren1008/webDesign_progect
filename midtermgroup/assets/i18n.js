...
(() => {
    const dictionaries = {
        en: {
            'faq.title': 'Smart FAQ',
            'faq.demo': 'Local rule-based demo assistant. No chat or personal data is uploaded.',
            ...
            'faq.machine_answer': 'Keep your order number and pickup code, then check Order History first. This project does not issue real refunds, but you may create a demo support case.',
        ...
        'zh-TW': {
            'faq.title': '智慧 FAQ',
            'faq.demo': '本機規則式 Demo 助理，不會上傳對話或個人資料。',
            'faq.machine': '機台故障未出餐',
            'faq.partner': '如何使用合作店家兌換券',
            'faq.order': '如何查看訂單與取餐狀態',
            'faq.machine_answer': '請保留訂單編號與取餐碼，先到「訂單紀錄」確認狀態。此專題不會自動退款，但可建立展示用客服案件。',
