...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!empty($db_error)) {
        $error = 'Login is temporarily unavailable while the account database is offline.';
    } else {
    ...
    <div class="container">
        ...
        <div class="auth-form">
            ...
            <div class="demo-credentials">
                <p><strong data-en="Quick Login Accounts:" data-zh="快速登入帳號：">Quick Login Accounts:</strong></p>
                <p>User: john_doe / user123</p>
                <p>Admin: admin / admin123</p>
                <div class="auth-buttons">
                    <button type="button" class="btn btn-secondary btn-small" data-fill-demo-login="user" data-en="Fill Member Account" data-zh="帶入一般會員">Fill Member Account</button>
                    <button type="button" class="btn btn-success btn-small" data-fill-demo-login="admin" data-en="Fill Admin Account" data-zh="帶入管理員">Fill Admin Account</button>
                </div>
            </div>
        </div>
