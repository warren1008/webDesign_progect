...
<body>
    <div class="container">
        ...
        <?php if (!empty($db_error)): ?>
            <div class="info">Temporary menu mode is active. Product browsing still works, while checkout requires the product database.</div>
        <?php endif; ?>
        ...
        <div class="dashboard-layout">
            <div class="enter-noodle">
                ...
                <div class="instruction">
                    <p>Scan the shelf QR code or tap a quick code to load an item.</p>
                </div>
                <form method="POST">
                ...
                <div class="kiosk-panel">
                    ...
                    <div class="qr-simulator" aria-label="QR code scanner">
