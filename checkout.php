        ...
        if ($payment_result['success']) {
            ...
            if ($order_result['success']) {
                ...
                $_SESSION['last_order'] = [
                    ...
                    'tax_id' => $tax_id,
                    'receipt_note' => '收據資訊已保存，電子發票資料請以實際開立結果為準。',
                    'card_type' => $card_type,
            ...
            <div class="payment-form">
                ...
                <form method="POST" data-payment-form>
                    ...
                    <div class="sandbox-receipt-box">
                        <h3 data-en="Receipt options" data-zh="電子收據選項">Receipt options</h3>
                        <p data-en="Add a mobile barcode or tax ID so your receipt information stays with this order."
                           data-zh="可填寫手機條碼或統一編號，讓收據資訊隨訂單保存。">Add a mobile barcode or tax ID so your receipt information stays with this order.</p>
                        <div class="form-row">
                            <div class="form-group">
                ...
                <div class="demo-note">
                    ...
                    <button type="button" class="btn btn-secondary btn-small" data-fill-demo-card>Use Saved Payment Details</button>
                </div>
            </div>
        </div>
