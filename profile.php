    ...
    <div class="container">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="profile-avatar-card">
                        <img class="profile-avatar-image"
                             src="<?php echo htmlspecialchars(displayImagePath($user['avatar_path'] ?? '', 'assets/images/avatars/avatar-default.svg')); ?>"
                             alt="Profile avatar">
                        <div class="profile-avatar-meta">
                            <strong data-en="Profile Avatar" data-zh="會員頭像">Profile Avatar</strong>
        ...
        <div class="profile-innovation-grid">
            <section class="innovation-card kiosk-login-card">
                ...
                <p data-en="Show this rotating credential at the unmanned kiosk to load your member profile."
                   data-zh="在實體無人機台前出示此條碼，即可快速載入會員資料與常用點餐。">Show this rotating credential at the unmanned kiosk to load your member profile.</p>
                <small>SECURE TOKEN · 不含密碼與原始 user_id</small>
            </section>
