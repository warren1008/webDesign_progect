...
function getDemoNoodles() {
    return [
        ...
        ['id' => 2, 'code' => 'N002', 'name' => 'Indomie Mi Goreng', 'brand' => 'Indomie', 'price' => 3.99, 'stock' => 100, 'image' => 'assets/images/noodles/N002-mi-goreng.webp'],
        ['id' => 3, 'code' => 'N003', 'name' => 'Mama Tom Yum', 'brand' => 'Mama', 'price' => 2.99, 'stock' => 75, 'image' => 'assets/images/noodles/N003-tom-yum.webp'],
        ['id' => 4, 'code' => 'N004', 'name' => 'Samyang Buldak', 'brand' => 'Samyang', 'price' => 6.99, 'stock' => 30, 'image' => 'assets/images/noodles/N004-buldak.webp'],
        ['id' => 5, 'code' => 'N005', 'name' => 'Maruchan Chicken', 'brand' => 'Maruchan', 'price' => 1.99, 'stock' => 200, 'image' => 'assets/images/noodles/N005-chicken.webp'],
        ['id' => 6, 'code' => 'N006', 'name' => 'Cup Noodles', 'brand' => 'Nissin', 'price' => 2.49, 'stock' => 150, 'image' => 'assets/images/noodles/N006-cup.webp'],
        ['id' => 7, 'code' => 'N007', 'name' => 'Sapporo Ichiban', 'brand' => 'Sapporo', 'price' => 2.29, 'stock' => 120, 'image' => 'assets/images/noodles/N007-shoyu.webp'],
        ['id' => 8, 'code' => 'N008', 'name' => 'Nissin Raoh', 'brand' => 'Nissin', 'price' => 3.49, 'stock' => 60, 'image' => 'assets/images/noodles/N008-tonkotsu.webp'],
    ];
}
...
function getNoodleToppingCatalog() {
    ...
    $fallback = [
        ...
        ['code' => 'chashu', 'name_zh' => '炙燒叉燒片', 'name_en' => 'Torched Chashu', 'description' => '無人加熱艙呈現炙燒風味。', 'price' => 1.45, 'stock' => 42, 'category' => 'protein'],
